    ...
    <div className="profile-info">
      ...
      <div className="container profile-text">
        ...
        {props.auth.isDriver ? (
          <React.Fragment>
            <p>
              <strong>Car color:</strong> {props.auth.driver_info.car_color}
            </p>
            <p>
              <strong>Car model:</strong> {props.auth.driver_info.car_model}
            </p>
            <p>
              <strong>Car number:</strong> {props.auth.driver_info.car_number}
            </p>
          </React.Fragment>
        ) : null}
